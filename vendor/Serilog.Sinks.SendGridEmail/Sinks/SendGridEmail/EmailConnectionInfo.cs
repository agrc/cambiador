...
namespace Serilog.Sinks.Email {
  ...
  public class EmailConnectionInfo {
    ...
    /// </summary>
    public EmailConnectionInfo(SendGridClient client, string fromEmail, string toEmail, string subject = DefaultSubject) {
    ...
    /// </summary>
    public ICredentialsByHost NetworkCredentials { get; set; } = default!;
    ...
    public string EmailSubject { get; set; } = DefaultSubject;
    ...
    /// manually.
    /// </remarks>
    public System.Net.Security.RemoteCertificateValidationCallback ServerCertificateValidationCallback { get; set; } = default!;
